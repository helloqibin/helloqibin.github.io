var LazyLoad = function() {
    ...
    var n = "undefined" != typeof window,
        ...
        w = function(t, n) {
            r ? t.classList.add(n) : t.className += (t.className ? " " : "") + n
        },
        y = function(t, n) {
            r ? t.classList.remove(n) : t.className = t.className.replace(new RegExp("(^|\\s+)" + n + "(\\s+|$)"), " ").replace(/^\s+/, "").replace(/\s+$/, "")
        },
        k = function(t) {
        ...
        W = function(t, n, e) {
            ...
            Q(t, n, e),
                function(t, n, e) {
                    var i = b(t, n.data_bg),
                        r = b(t, n.data_bg_hidpi),
                        o = a && r ? r : i;
                    o && (t.style.backgroundImage = 'url("'.concat(o, '")'),
                        k(t).setAttribute("src", o),
                        j(t, n, e))
                }(t, n, e),
                function(t, n, e) {
                    var i = b(t, n.data_bg_multi),
                        r = b(t, n.data_bg_multi_hidpi),
                        o = a && r ? r : i;
            ...
            t.forEach((function(t) {
                return function(t) {
                    ...
                    h(t, "entered"),
                        ...
                        L(e.callback_enter, t, n, i),
                        function(t) {
                            return I.indexOf(p(t)) >= 0
                        }(t) || X(t, e, i)
                }(t.target, t, n, e) : function(t, n, e, i) {
                    E(t) || (w(t, e.class_exited),
                        function(t, n, e, i) {
                            e.cancel_on_exit && function(t) {
                                ...
                                z(i, -1),
                                m(t),
                                L(e.callback_cancel, t, n, i))
                        }(t, n, e, i),
                        L(e.callback_exit, t, n, i))
                }(t.target, t, n, e)
            }))
        },
        nt = function(t) {
    ...
    return at.prototype = {
            update: function(t) {
                var n, r, a = this._settings,
                    o = rt(t, a);
                x(this, o.length), !e && i ? Z(a) ? function(t, n, e) {
                    t.forEach((function(t) {
        ...
        at.load = function(t, n) {
            var e = c(n);
            X(t, e)
        },
        at.resetStatus = function(t) {
            m(t)
        },
        n && function(t, n) {
            if (n)

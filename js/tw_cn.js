...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const defaultEncoding = translate.defaultEncoding // 网站默认语言，1: 繁体中文, 2: 简体中文
    const translateDelay = translate.translateDelay // 延迟时间,若不在前, 要设定延迟翻译时间, 如100表示100ms,默认为0
    const msgToTraditionalChinese = '<i class="fa-solid fa-earth-asia"></i><span>轉為繁體</span>' // 此处可以更改为你想要显示的文字
    const msgToSimplifiedChinese = '<i class="fa-solid fa-earth-asia"></i><span>转为简体</span>' // 同上，但两处均不建议更改

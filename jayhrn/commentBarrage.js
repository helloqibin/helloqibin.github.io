var commentBarrageConfig = {
    ...
    barrageTime: 4000,
    //twikoo部署地址腾讯云的为环境ID
    twikooUrl: "https://twikoo.lovelu.top/",
    //token获取见上方
    accessToken: "9684346771dcbe8fbd93f8bb5a0046d8",
...
function popCommentBarrage(data) {
    ...
    barrage.innerHTML = `
      ...
      <a class="barrageTitle" href="javascript:Jay.scrollTo('#post-comment')"">热评</a>
			<div class="barrageNick">${data.nick}</div>
			<img class="barrageAvatar" src="https://cravatar.cn/avatar/${data.mailMd5}"/>
			<a class="comment-barrage-close" href="javascript:Jay.switchCommentBarrage()"><i class="fa-solid fa-xmark"></i></a>
		</div>

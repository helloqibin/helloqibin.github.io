...
function navTitle () {
  ...
  document.getElementById("page-name-text").innerHTML = titleValue.replace(' | 满心', '');
}
...
//友链随机传送
function travelling () {
  var fetchUrl = "https://fcircle.lovelu.top/randomfriend"
  //var fetchUrl = 'https://fcircle.lovelu.top/randomfriend'
  fetch(fetchUrl)
    .then(res => res.json())
    .then(json => {
      ...
      document.styleSheets[0].addRule(':root', '--Jay-snackbar-time:' + 8000 + 'ms!important');
      Snackbar.show({
        text: msg,
        duration: 8000,
        pos: 'top-center',
...
$(window).on('keydown', function (ev) {
  ...
  if (Jay_keyboard && ev.shiftKey && !Jay_intype) {
...
document.addEventListener('pjax:complete', function () {
  ...
  percent()
  Jay.topPostScroll()
  Jay.topCategoriesBarScroll()
  Jay.sayhi()
  Jay.addTag()
  Jay.stopImgRightDrag()
  Jay.addFriendLinksInFooter()
  Jay.qrcodeCreate()
  Jay.hidecookie()
  Jay.onlyHome()
  Jay.addNavBackgroundInit()
  Jay.initIndexEssay()
  Jay.changeTimeInEssay()
  Jay.refreshEssayWaterFall()
  // Jay.addMediumInEssay()
  Jay.darkModeStatus()
  Jay.categoriesBarActive()
  Jay.initThemeColor()
  Jay.hideLoading()
  Jay.tagPageActive()
})